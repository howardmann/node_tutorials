// Same code as in 9-routes example except here we are separating concerns of the routes into a separate file
// To be able to separate concerns and access the routes as a module we need to use the builtin express.Router() helper. We set all the code in an instance of the express.Router(), export it and then import it from our server file. We can then access it as middleware using the .user method. Official doc explanation:
